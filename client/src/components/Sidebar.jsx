...
import { House, SquarePen, Hash, Image, LogOut, Eraser, ScissorsIcon, User, FileText } from 'lucide-react';
...
const Sidebar = ({ sidebar, setsidebar }) => {
    ...
    return (
        <div className={`w-60 bg-white border-r border-gray-200 flex flex-col items-center max-sm:absolute  justify-between top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>

            <div className='px-6 text-sm text-gray-600 font-medium w-full'>
